...
<tr style="background-color:gold"><td><div style="font-size:14px; font-weight:bold;">设置邮件标识白名单</div></td></tr>
<tr>
<td>
<%
	dim how
...
<input type=checkbox name=buseblack style="border-color:white" <%if rs("busewhite") then Response.Write "Checked" end if%>>启用邮件标识白名单<br>
<textarea name="mailids" style="width:200px;height:120px"><%
	
	Response.Write rs("whitelist")
	rs.Close
	Connect.Close
%>
</textarea><br>
